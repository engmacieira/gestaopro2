...
from app.schemas.processolicitatorio_schema import ProcessolicitatorioRequest, ProcessolicitatorioResponse
from app.repositories.processolicitatorio_repository import ProcessolicitatorioRepository

router = APIRouter(
    prefix="/processoslicitatorios",      
    tags=["Processolicitatorio"],       
...
def create_processoslicitatorios(
    processoslicitatorios_req: ProcessolicitatorioRequest, 
...
@router.put("/{id}", response_model=ProcessolicitatorioResponse)

...
class ItemRepository:
    def __init__(self, db_conn: connection):
        ...
        self.contratos_repo = ContratoRepository(db_conn)

    #Mapear
    def _map_row_to_model(self, row: DictCursor) -> Item:
    ...
    #Criar
    def create(self, itens_req: ItemRequest) -> Item:
        cursor = None
        try:
            #repositório
    ...
    def get_by_descricao(self, descricao: str) -> Item:
        cursor = None
        try:
            cursor = self.db_conn.cursor(cursor_factory=DictCursor)
    ...
    #Atualizar
    def update(self, id: int, itens_req: ItemRequest) -> Item | None:
        cursor = None
        try:
            #repositório
            cont = self.contratos_repo.get_by_numero_contrato(itens_req.contrato_nome)

...
from app.schemas.anexo_schema import AnexoRequest
...
class AnexoRepository:
    def __init__(self, db_conn: connection):
        ...
        self.tiposdocumentos_repo = TipodocumentoRepository(db_conn)

    #Mapear
    def _map_row_to_model(self, row: DictCursor) -> Anexo:
    ...
    #Criar
    def create(self, anexos_req: AnexoRequest) -> Anexo:
        cursor = None
        try:
            #repositório
    ...
    #Atualizar
    def update(self, id: int, anexos_req: AnexoRequest) -> Anexo | None:
        cursor = None
        try:
            #repositório

...
class Contratos:
    def __init__(self, id: int, id_categoria: int, numero_contrato: str, fornecedor_obj: Fornecedor, data_inicio: date, data_fim: date, 
    data_criacao: date, ativo: bool, id_instrumento_contratual: int, id_modalidade: int, id_numero_modalidade: int, id_processo_licitatorio: int):
            self.id: int = id

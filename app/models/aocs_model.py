...
class Aocs:
    def __init__(self, id: int, numero_aocs: str, data_criacao: date, justificativa: str, local_data: str, id_unidade_requisitante: int, id_local_entrega: int,
    id_agente_responsavel: int, id_dotacao: int, numero_pedido: str | None = None, tipo_pedido: str | None = None, empenho: str | None = None):
        self.id: int = id
